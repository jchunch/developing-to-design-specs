...
public class SmallTile extends Tile implements Parcelable {
    ...
    public static final Creator<SmallTile> CREATOR = new Creator<SmallTile>() {

        @Override
        public SmallTile createFromParcel(Parcel source) {
        ...
        @Override
        public SmallTile[] newArray(int size) {

            return new SmallTile[size];
        }
    };
}
