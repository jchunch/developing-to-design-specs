 ...
 */
public class LargeTile extends Tile implements Parcelable {
    ...
    public LargeTile(String header, String body, String imageUrl) {
        this.header = header;
        this.body = body;
    ...
    public static final Parcelable.Creator<LargeTile> CREATOR = new Creator<LargeTile>() {

        @Override
        public LargeTile createFromParcel(Parcel source) {
